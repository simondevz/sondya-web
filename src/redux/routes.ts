...
const BASE = "https://sondya-backend.onrender.com/api/v1";
const WS_BASE = "wss://sondya-backend.onrender.com/api/v1";
// const BASE = "http://localhost:8000/api/v1"; // for testing on localhost
// const WS_BASE = "ws://localhost:8000/api/v1"; // for testing on localhost
